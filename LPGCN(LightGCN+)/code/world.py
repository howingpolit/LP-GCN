...
train_loss_process_record_path = join(RESULT_PATH, 'train_loss_process_record.csv')
evolution_process_record_path = join(RESULT_PATH, 'evolution_process_record.csv')
